...
#### <a name="azurestorage"></a><span data-ttu-id="1b7fe-112">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="1b7fe-112">Azure.Storage</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="1b7fe-131">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="1b7fe-131">AzureRM.Network</span></span>
...
* <span data-ttu-id="1b7fe-155">Application Gateway에서 신뢰할 수 있는 루트 인증서 및 크기 자동 조정 구성에 대한 지원이 추가되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-155">Added support for Trusted Root certificate and Autoscale configuration in Application Gateway</span></span>
  - <span data-ttu-id="1b7fe-156">추가된 새 cmdlet은 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-156">New Cmdlets added:</span></span>
      - <span data-ttu-id="1b7fe-157">Add-AzureRmApplicationGatewayTrustedRootCertificate</span><span class="sxs-lookup"><span data-stu-id="1b7fe-157">Add-AzureRmApplicationGatewayTrustedRootCertificate</span></span>
...
* <span data-ttu-id="1b7fe-175">서브넷에서 여러 주소 접두사에 대한 지원이 추가되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-175">Added support for multiple address prefixes in a subnet.</span></span> <span data-ttu-id="1b7fe-176">다음 Cmdlet이 업데이트 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-176">Updated cmdlets:</span></span>
  ...
  - <span data-ttu-id="1b7fe-181">Add-AzureRmApplicationGatewayAuthenticationCertificate</span><span class="sxs-lookup"><span data-stu-id="1b7fe-181">Add-AzureRmApplicationGatewayAuthenticationCertificate</span></span>
...
#### <a name="azurermrediscache"></a><span data-ttu-id="1b7fe-204">AzureRM.RedisCache</span><span class="sxs-lookup"><span data-stu-id="1b7fe-204">AzureRM.RedisCache</span></span>
...
* <span data-ttu-id="1b7fe-218">AzureRm.Storage에서 불변성 정책 지원</span><span class="sxs-lookup"><span data-stu-id="1b7fe-218">Support Immutability Policy in AzureRm.Storage</span></span> 
    ...
    - <span data-ttu-id="1b7fe-228">Remove-AzureRmStorageContainerImmutabilityPolicy</span><span class="sxs-lookup"><span data-stu-id="1b7fe-228">Remove-AzureRmStorageContainerImmutabilityPolicy</span></span>
...
* <span data-ttu-id="1b7fe-247">문제 https://github.com/Azure/azure-powershell/issues/6814 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-247">Fixed issue https://github.com/Azure/azure-powershell/issues/6814</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="1b7fe-263">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="1b7fe-263">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="1b7fe-282">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="1b7fe-282">AzureRM.Network</span></span>
...
## <a name="670---august-2018"></a><span data-ttu-id="1b7fe-300">6.7.0 - 2018년 8월</span><span class="sxs-lookup"><span data-stu-id="1b7fe-300">6.7.0 - August 2018</span></span>
...
#### <a name="azurermapplicationinsights"></a><span data-ttu-id="1b7fe-315">AzureRM.ApplicationInsights</span><span class="sxs-lookup"><span data-stu-id="1b7fe-315">AzureRM.ApplicationInsights</span></span>
...
#### <a name="azurermconsumption"></a><span data-ttu-id="1b7fe-335">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="1b7fe-335">AzureRM.Consumption</span></span>
...
#### <a name="azurermdevtestlabs"></a><span data-ttu-id="1b7fe-352">AzureRM.DevTestLabs</span><span class="sxs-lookup"><span data-stu-id="1b7fe-352">AzureRM.DevTestLabs</span></span>
...
#### <a name="azurermmachinelearning"></a><span data-ttu-id="1b7fe-370">AzureRM.MachineLearning</span><span class="sxs-lookup"><span data-stu-id="1b7fe-370">AzureRM.MachineLearning</span></span>
...
#### <a name="azurermnotificationhubs"></a><span data-ttu-id="1b7fe-387">AzureRM.NotificationHubs</span><span class="sxs-lookup"><span data-stu-id="1b7fe-387">AzureRM.NotificationHubs</span></span>
...
#### <a name="azurermrecoveryservicessiterecovery"></a><span data-ttu-id="1b7fe-405">AzureRM.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="1b7fe-405">AzureRM.RecoveryServices.SiteRecovery</span></span>
...
#### <a name="azurermservicebus"></a><span data-ttu-id="1b7fe-426">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="1b7fe-426">AzureRM.ServiceBus</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="1b7fe-442">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="1b7fe-442">AzureRM.Websites</span></span>
...
#### <a name="azurermcompute"></a><span data-ttu-id="1b7fe-460">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="1b7fe-460">AzureRM.Compute</span></span>
...
* <span data-ttu-id="1b7fe-472">ADF.Net SDK 버전을 1.1.0으로 업데이트했습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-472">Updated the ADF .Net SDK version to 1.1.0.</span></span>
* <span data-ttu-id="1b7fe-473">데이터 팩터리를 공유하는 자체 호스팅된 통합 런타임을 지원합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-473">Support self-hosted integration runtime sharing across data factories.</span></span>
     - <span data-ttu-id="1b7fe-474">새 매개 변수 -SharedIntegrationRuntimeResourceId를 Set-AzureRmDataFactoryV2IntegrationRuntime cmdlet에 추가.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-474">Add new parameter -SharedIntegrationRuntimeResourceId to Set-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>
     - <span data-ttu-id="1b7fe-475">새로운 선택적 매개 변수 -LinkedDataFactoryName을 Remove-AzureRmDataFactoryV2IntegrationRuntime cmdlet에 추가.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-475">Add new optional parameter -LinkedDataFactoryName to Remove-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="1b7fe-476">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="1b7fe-476">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="1b7fe-477">DataPlane SDK(Microsoft.Azure.DataLake.Store) 버전을 1.1.9로 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-477">Updated the DataPlane SDK (Microsoft.Azure.DataLake.Store) version to 1.1.9</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="1b7fe-478">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="1b7fe-478">AzureRM.EventHub</span></span>
* <span data-ttu-id="1b7fe-479">cmdlet 제거에서 InputObject 및 ResourceId에 대한 파이핑이 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-479">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>

#### <a name="azurerminsights"></a><span data-ttu-id="1b7fe-480">AzureRM.Insights</span><span class="sxs-lookup"><span data-stu-id="1b7fe-480">AzureRM.Insights</span></span>
* <span data-ttu-id="1b7fe-481">도움말 파일에서 OutputType 서식 지정 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-481">Fixed formatting of OutputType in help files</span></span>
* <span data-ttu-id="1b7fe-482">Microsoft.Azure.Management.Monitor SDK 0.19.1-preview를 사용</span><span class="sxs-lookup"><span data-stu-id="1b7fe-482">Using Microsoft.Azure.Management.Monitor SDK 0.19.1-preview</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="1b7fe-483">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="1b7fe-483">AzureRM.KeyVault</span></span>
* <span data-ttu-id="1b7fe-484">Set-AzureRmKeyVaultAccessPolicy 내 파이핑 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-484">Fix piping issue in Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="1b7fe-485">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="1b7fe-485">AzureRM.Network</span></span>
* <span data-ttu-id="1b7fe-486">LoadBalancerInboundNatPoolConfig cmdlet에 대한 예제가 추가되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-486">Added examples for LoadBalancerInboundNatPoolConfig cmdlets.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="1b7fe-487">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="1b7fe-487">AzureRM.Resources</span></span>
* <span data-ttu-id="1b7fe-488">'Get-AzureRmResource'에 대한 태그 이름 및 값을 제공할 때의 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-488">Fix issue when providing both tag name and value for 'Get-AzureRmResource'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6765
* <span data-ttu-id="1b7fe-489">'Set-AzureRmResource'를 사용하여 파이핑 시나리오 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-489">Fix piping scenario with 'Set-AzureRmResource'</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="1b7fe-490">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="1b7fe-490">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="1b7fe-491">cmdlet 제거에서 InputObject 및 ResourceId에 대한 파이핑이 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-491">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>
* <span data-ttu-id="1b7fe-492">몇 가지 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-492">fixed few issues</span></span>
    - https://github.com/Azure/azure-powershell/issues/3780
    - https://github.com/Azure/azure-powershell/issues/4340

#### <a name="azurermsql"></a><span data-ttu-id="1b7fe-493">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="1b7fe-493">AzureRM.Sql</span></span>
* <span data-ttu-id="1b7fe-494">다음 cmdlet 사용하여 서버 Advanced Threat Protection 지원을 추가합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-494">Adding Server Advanced Threat Protection support with the following cmdlets:</span></span>
    - <span data-ttu-id="1b7fe-495">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span><span class="sxs-lookup"><span data-stu-id="1b7fe-495">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span></span>
* <span data-ttu-id="1b7fe-496">다음 cmdlet을 사용하여 취약성 평가 지원을 추가합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-496">Adding Vulnerability Assessment support with the following cmdlets:</span></span>
    - <span data-ttu-id="1b7fe-497">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span><span class="sxs-lookup"><span data-stu-id="1b7fe-497">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span></span>
    - <span data-ttu-id="1b7fe-498">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="1b7fe-498">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>
    - <span data-ttu-id="1b7fe-499">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="1b7fe-499">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span></span>
* <span data-ttu-id="1b7fe-500">Remove-AzureRmSqlServerFirewallRule의 예제 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-500">Fixed example in Remove-AzureRmSqlServerFirewallRule</span></span>
* <span data-ttu-id="1b7fe-501">Get-AzureSqlSyncGroupLog에서 미국이 아닌 문화권에서 날짜/시간을 올바르지 않게 다루는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-501">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="1b7fe-502">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="1b7fe-502">AzureRM.Storage</span></span>
* <span data-ttu-id="1b7fe-503">Ps1XmlAttribute를 cmdlet 출력 형식 속성에 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-503">Add Ps1XmlAttribute to cmdlets output types properties</span></span>
* <span data-ttu-id="1b7fe-504">StorageAccount cmdlet 출력을 테이블 뷰로 표시</span><span class="sxs-lookup"><span data-stu-id="1b7fe-504">Show StorageAccount cmdlet output in table view</span></span>
    - <span data-ttu-id="1b7fe-505">Get-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="1b7fe-505">Get-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="1b7fe-506">New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="1b7fe-506">New-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="1b7fe-507">Set-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="1b7fe-507">Set-AzureRmStorageAccount</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="1b7fe-508">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="1b7fe-508">AzureRM.Tags</span></span>
* <span data-ttu-id="1b7fe-509">태그 cmdlet 도움말에서 잘못된 문을 제거합니다</span><span class="sxs-lookup"><span data-stu-id="1b7fe-509">Remove incorrect statement from Tag cmdlet help</span></span>
    - https://github.com/Azure/azure-powershell/issues/3878

## <a name="650---july-2018"></a><span data-ttu-id="1b7fe-510">6.5.0 - 2018년 7월</span><span class="sxs-lookup"><span data-stu-id="1b7fe-510">6.5.0 - July 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="1b7fe-511">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="1b7fe-511">AzureRM.Profile</span></span>
* <span data-ttu-id="1b7fe-512">'Get-AzureRmContextAutosaveSetting'에 대한 도움말이 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-512">Updated help for 'Get-AzureRmContextAutosaveSetting'</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="1b7fe-513">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="1b7fe-513">Azure.Storage</span></span>
* <span data-ttu-id="1b7fe-514">쓰기 전용 SaS 토큰을 사용하는 Blob 또는 파일 업로드 지원</span><span class="sxs-lookup"><span data-stu-id="1b7fe-514">Support Upload Blob or File with write only Sas token</span></span>
- <span data-ttu-id="1b7fe-515">Set-AzureStorageBlobContent</span><span class="sxs-lookup"><span data-stu-id="1b7fe-515">Set-AzureStorageBlobContent</span></span>
- <span data-ttu-id="1b7fe-516">Set-AzureStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="1b7fe-516">Set-AzureStorageFileContent</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="1b7fe-517">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="1b7fe-517">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="1b7fe-518">필수 속성 ResourceGroupName을 AS에 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-518">Add required property ResourceGroupName to AS.</span></span>

#### <a name="azurermautomation"></a><span data-ttu-id="1b7fe-519">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="1b7fe-519">AzureRM.Automation</span></span>
* <span data-ttu-id="1b7fe-520">도움말을 업데이트하고 'New-AzureRMAutomationSchedule'에 대한 예제 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-520">Update help and add example for 'New-AzureRMAutomationSchedule'</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="1b7fe-521">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="1b7fe-521">AzureRM.Compute</span></span>
* <span data-ttu-id="1b7fe-522">-Tag 매개 변수를 Update/New-AzureRmAvailabilitySet에 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-522">Add -Tag parameter to Update/New-AzureRmAvailabilitySet</span></span>
* <span data-ttu-id="1b7fe-523">‘Add-AzureRmVmssExtension’에 대한 예제 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-523">Add example for 'Add-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="1b7fe-524">‘Remove-AzureRmVmssExtension’에 대한 예제 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-524">Add examples for 'Remove-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="1b7fe-525">‘Set-AzureRmVMAccessExtension’에 대한 도움말 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-525">Update help for 'Set-AzureRmVMAccessExtension'</span></span>
* <span data-ttu-id="1b7fe-526">기본으로 SinglePlacementGroup을 false로 설정하고 단일 배치 그룹에 VMSS를 만들 수 있는 스위치 매개 변수 'SinglePlacementGroup'을 추가하도록 New-AzureRmVmss에 대한 SimpleParameterSet을 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-526">Update SimpleParameterSet for New-AzureRmVmss to set SinglePlacementGroup to false by default and add switch parameter 'SinglePlacementGroup' that enables the user to create the VMSS in a single placement group.</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="1b7fe-527">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="1b7fe-527">AzureRM.EventHub</span></span>
* <span data-ttu-id="1b7fe-528">PSEventHubDRConfigurationAttributes 클래스에 읽기 전용 속성 'PendingReplicationOperationsCount'를 추가하여 복제가 진행되는 동안 보류 중인 복제 작업 수를 제공</span><span class="sxs-lookup"><span data-stu-id="1b7fe-528">Added a readonly property 'PendingReplicationOperationsCount' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="1b7fe-529">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="1b7fe-529">AzureRM.KeyVault</span></span>
* <span data-ttu-id="1b7fe-530">Set-AzureRmKeyVaultAccessPolicy에 대한 오류 메시지 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-530">Update error message for Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermlogicapp"></a><span data-ttu-id="1b7fe-531">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="1b7fe-531">AzureRM.LogicApp</span></span>
* <span data-ttu-id="1b7fe-532">New-AzureRmLogicApp에서 "매개 변수 집합을 확인할 수 없습니다" 오류 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-532">Fixed "parameter set could not be resolved" error in New-AzureRmLogicApp</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="1b7fe-533">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="1b7fe-533">AzureRM.Network</span></span>
* <span data-ttu-id="1b7fe-534">Set/Add-AzureRmVirtualNetworkPeering에 대한 여러 테넌트의 가상 네트워크에서 피어링을 사용하도록 설정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-534">Enable peering across Virtual Networks in multiple Tenants for Set/Add-AzureRmVirtualNetworkPeering</span></span>
* <span data-ttu-id="1b7fe-535">Application Gateway에 대한 아래 cmdlet 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-535">Updated below cmdlets for Application Gateway</span></span>
    - <span data-ttu-id="1b7fe-536">New-AzureRmApplicationGateway: EnableFIPS 플래그 및 영역 지원 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-536">New-AzureRmApplicationGateway : Added EnableFIPS flag and Zones support</span></span>
    - <span data-ttu-id="1b7fe-537">New-AzureRmApplicationGatewaySku: 새 sku Standard_v2 및 WAF_v2 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-537">New-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
    - <span data-ttu-id="1b7fe-538">Set-AzureRmApplicationGatewaySku: 새 sku Standard_v2 및 WAF_v2 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-538">Set-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
* <span data-ttu-id="1b7fe-539">최신 생성기를 사용하여 RouteTable cmdlet을 재생성</span><span class="sxs-lookup"><span data-stu-id="1b7fe-539">Regenerated RouteTable cmdlets with the latest generator version</span></span>

#### <a name="azurermrelay"></a><span data-ttu-id="1b7fe-540">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="1b7fe-540">AzureRM.Relay</span></span>
* <span data-ttu-id="1b7fe-541">markdown 파일을 업데이트하여 예제에서 매개 변수 이름 문제에 대해 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-541">Updated markdown files, fix for the parameter name issue in example</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="1b7fe-542">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="1b7fe-542">AzureRM.Resources</span></span>
* <span data-ttu-id="1b7fe-543">Roledefinition 및 Roleassignment cmdlet을 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-543">Update Roleassignment and roledefinition cmdlets:</span></span>
    - <span data-ttu-id="1b7fe-544">페이징의 일부분으로 수행하는 추가 roledefinition 호출을 제거합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-544">Remove extra roledefinition calls done as part of paging.</span></span>
* <span data-ttu-id="1b7fe-545">Get-AzureRmRoleAssignment cmdlet 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-545">Fix Get-AzureRmRoleAssignment cmdlet</span></span>
    - <span data-ttu-id="1b7fe-546">-ExpandPrincipalGroups 명령 매개 변수 기능 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-546">Fix -ExpandPrincipalGroups command parameter functionality</span></span>
* <span data-ttu-id="1b7fe-547">'Get-AzureRmResource'에서 '-ResourceType' 매개 변수가 대/소문자를 구분하는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-547">Fix issue with 'Get-AzureRmResource' where '-ResourceType' parameter was case sensitive</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="1b7fe-548">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="1b7fe-548">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="1b7fe-549">top 및 skip 매개 변수가 cmdlet 목록을 나열하도록 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-549">Added top and skip parameter to list cmdlets</span></span>
* <span data-ttu-id="1b7fe-550">표준을 프리미엄 네임스페이스 마이그레이션 cmdlet에 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-550">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    - <span data-ttu-id="1b7fe-551">Start-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="1b7fe-551">Start-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="1b7fe-552">Get-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="1b7fe-552">Get-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="1b7fe-553">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="1b7fe-553">Complete-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="1b7fe-554">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="1b7fe-554">Stop-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="1b7fe-555">Remove-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="1b7fe-555">Remove-AzureRmServiceBusMigration</span></span>
* <span data-ttu-id="1b7fe-556">PSServiceBusDRConfigurationAttributes 클래스에 읽기 전용 속성 'PendingReplicationOperationsCount'를 추가하여 복제가 진행되는 동안 보류 중인 복제 작업 수를 제공</span><span class="sxs-lookup"><span data-stu-id="1b7fe-556">Added a readonly property 'PendingReplicationOperationsCount' to PSServiceBusDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="1b7fe-557">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="1b7fe-557">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="1b7fe-558">‘New-AzureRmServiceFabricCluster’에 대한 예제 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-558">Update example for 'New-AzureRmServiceFabricCluster'</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="1b7fe-559">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="1b7fe-559">AzureRM.Sql</span></span>
* <span data-ttu-id="1b7fe-560">Management.Sql에 대한 새 cmdlet을 추가하여 고객이 TDE 인증서를 SQL Server 인스턴스 또는 Managed Instance에 추가할 수 있도록 허용</span><span class="sxs-lookup"><span data-stu-id="1b7fe-560">Adding new Cmdlets for Management.Sql to allow customers to add TDE Certificate to Sql Server instance or a Managed Instance</span></span>
    - <span data-ttu-id="1b7fe-561">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="1b7fe-561">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span></span>
    - <span data-ttu-id="1b7fe-562">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="1b7fe-562">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="1b7fe-563">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="1b7fe-563">AzureRM.Websites</span></span>
* <span data-ttu-id="1b7fe-564">`Set-AzureRmWebApp -AssignIdentity` 및 `Set-AzureRmWebAppSlot -AssignIdentity`가 false로 설정되면 사이트 개체에서 Identity 속성이 제거됩니다. 미리보기 태그도 제거됩니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-564">`Set-AzureRmWebApp -AssignIdentity` and  `Set-AzureRmWebAppSlot -AssignIdentity` when set to false will now remove the Identity property from the site object.Removing preview tag as well.</span></span>
* <span data-ttu-id="1b7fe-565">`Get-AzureRmWebAppMetrics`, `Get-AzureRmAppServicePlanMetrics` 예제가 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-565">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` example updated</span></span>
* <span data-ttu-id="1b7fe-566">`Set-AzureRmWebApp -PhpVersion`이 유효한 php 버전으로 해제 지원</span><span class="sxs-lookup"><span data-stu-id="1b7fe-566">`Set-AzureRmWebApp -PhpVersion` supports off as a valid php version</span></span>

## <a name="640---july-2018"></a><span data-ttu-id="1b7fe-567">6.4.0 - 2018년 7월</span><span class="sxs-lookup"><span data-stu-id="1b7fe-567">6.4.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="1b7fe-568">일반</span><span class="sxs-lookup"><span data-stu-id="1b7fe-568">General</span></span>
* <span data-ttu-id="1b7fe-569">대부분의 모듈에 대한 도움말 파일에서 OutputType 서식 지정 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-569">Fixed formatting of OutputType in help files for most modules</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="1b7fe-570">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="1b7fe-570">AzureRM.Profile</span></span>
* <span data-ttu-id="1b7fe-571">기본 출력 형식에 추가된 Ps1Xml 특성</span><span class="sxs-lookup"><span data-stu-id="1b7fe-571">Ps1Xml attribute added to the basic output types</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="1b7fe-572">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="1b7fe-572">AzureRM.Compute</span></span>
* <span data-ttu-id="1b7fe-573">VMSS에 대한 IP 태그 기능</span><span class="sxs-lookup"><span data-stu-id="1b7fe-573">IP Tag feature for VMSS</span></span>
    - <span data-ttu-id="1b7fe-574">'New-AzureRmVmssIpTagConfig' cmdlet 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-574">'New-AzureRmVmssIpTagConfig' cmdlet is added</span></span>
    - <span data-ttu-id="1b7fe-575">New-AzureRmVmssIpConfig에 IpTag 매개 변수가 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-575">IpTag parameter is added to New-AzureRmVmssIpConfig</span></span>
* <span data-ttu-id="1b7fe-576">VMSS에 대한 자동 OS 롤백 기능</span><span class="sxs-lookup"><span data-stu-id="1b7fe-576">Auto OS Rollback feature for VMSS</span></span>
    - <span data-ttu-id="1b7fe-577">New-AzureRmVmssConfig 및 Update-AzureRmVmss에 DisableAutoRollback 매개 변수가 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-577">DisableAutoRollback parameters are added to New-AzureRmVmssConfig and Update-AzureRmVmss</span></span>
* <span data-ttu-id="1b7fe-578">Vmss에 대한 OS 업그레이드 기록 기능</span><span class="sxs-lookup"><span data-stu-id="1b7fe-578">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="1b7fe-579">Get-AzureRmVmss에 OSUpgradeHistory 스위치 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-579">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>

#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="1b7fe-580">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="1b7fe-580">AzureRM.DataLakeAnalytics</span></span>
* <span data-ttu-id="1b7fe-581">다음 명령을 통해 카탈로그 액세스 제어 목록에 대한 지원을 추가합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-581">Add support for Catalog ACLs through the following commands:</span></span>
    - <span data-ttu-id="1b7fe-582">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="1b7fe-582">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="1b7fe-583">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="1b7fe-583">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="1b7fe-584">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="1b7fe-584">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="1b7fe-585">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="1b7fe-585">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="1b7fe-586">Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl에 대한 취소 지원 및 진행률 추적 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-586">Add cancellation support and progress tracking for Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span></span>
* <span data-ttu-id="1b7fe-587">Export-AzureRmDataLakeStoreChildItemProperties에 대한 취소 지원 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-587">Add cancellation support for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="1b7fe-588">재귀 작업을 수행하는 cmdlet에 대한 디버그 메시지 플러시 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-588">Fix flushing of debug messages for cmdlets that does recursive operations</span></span>
* <span data-ttu-id="1b7fe-589">DataLake cmdlet의 테스트 위치 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-589">Fix location of test of DataLake cmdlets</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="1b7fe-590">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="1b7fe-590">AzureRM.EventHub</span></span>
* <span data-ttu-id="1b7fe-591">목록 작업 cmdlet Get-AzureRmEventHub 및 Get-AzureRmEventHubConsumerGroup에 선택적 MaxCount 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-591">Added Optional MaxCount parameter to List Operations cmdlet Get-AzureRmEventHub and Get-AzureRmEventHubConsumerGroup</span></span>
* <span data-ttu-id="1b7fe-592">새 EventHub 만드는 동안 하나 이상의 매개 변수가 필요한 New-AzureRmEventHub cmdlet 문제를 해결.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-592">Fixed issue in New-AzureRmEventHub cmdlet where at least one parameter needed while creating New EventHub.</span></span> <span data-ttu-id="1b7fe-593">기본 매개 변수 집합을 제공.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-593">Provided Default Parameter set.</span></span>
* <span data-ttu-id="1b7fe-594">선택적 매개 변수 -KeyValue를 New-AzureRmEventHubKey cmdlet에 추가 하여 사용자가 KeyValue를 제공할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-594">Added optional Parameter -KeyValue to New-AzureRmEventHubKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="1b7fe-595">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="1b7fe-595">AzureRM.KeyVault</span></span>
* <span data-ttu-id="1b7fe-596">Get-AzureRmKeyVault -Tag 실행 시 모든 리소스가 리턴되는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-596">Fix issue where all resources were being returned by Get-AzureRmKeyVault -Tag</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="1b7fe-597">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="1b7fe-597">AzureRM.Network</span></span>
* <span data-ttu-id="1b7fe-598">영역 중복 VirtualNetworkGateways에 대한 새 Sku를 노출합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-598">Expose new Skus for Zone-Redundant VirtualNetworkGateways</span></span>
* <span data-ttu-id="1b7fe-599">기능에 대한 새 명령이 추가됨: ARM을 통한 ExpressRoute Partner APIs</span><span class="sxs-lookup"><span data-stu-id="1b7fe-599">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    - <span data-ttu-id="1b7fe-600">Get- AzureRmExpressRouteCrossConnection 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-600">Added Get-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="1b7fe-601">Set-AzureRmExpressRouteCrossConnection 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-601">Added Set-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="1b7fe-602">Add-AzureRmExpressRouteCrossConnectionPeering 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-602">Added Add-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="1b7fe-603">Get-AzureRmExpressRouteCrossConnectionPeering 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-603">Added Get-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="1b7fe-604">Remove-AzureRmExpressRouteCrossConnectionPeering 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-604">Added Remove-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="1b7fe-605">Get-AzureRMExpressRouteCrossConnectionArpTable 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-605">Added Get-AzureRMExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="1b7fe-606">Get-AzureRMExpressRouteCrossConnectionRouteTable 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-606">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="1b7fe-607">Get-AzureRMExpressRouteCrossConnectionRouteTableSummary 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-607">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="1b7fe-608">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="1b7fe-608">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="1b7fe-609">Get-AzureRmRecoveryServicesBackupStatus cmdlet 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-609">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="1b7fe-610">이 cmdlet은 VM ID를 가져와서 VM이 구독에서 일부 자격 증명 모음으로 보호되는지 확인합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-610">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="1b7fe-611">이러한 자격 증명 모음이 존재하는 경우 cmdlet은 자격 증명 모음 세부 정보를 출력 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-611">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="1b7fe-612">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="1b7fe-612">AzureRM.Resources</span></span>
* <span data-ttu-id="1b7fe-613">Get-AzureRmPolicyAssignment cmdlet을 다음과 같이 업데이트함.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-613">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="1b7fe-614">관리 그룹 수준에서 -Scope 값 리스팅에 대한 지원 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-614">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="1b7fe-615">관리 그룹 수준에서 -Scope 값을 사용하여 개별 할당값을 검색하는 것에 대한 지원 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-615">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="1b7fe-616">제어 매개 변수에 -Effective 및 -All 스위치 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-616">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="1b7fe-617">Get/New/Remove/Set-AzureRmPolicyDefinition cmdlet 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-617">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="1b7fe-618">지정된 관리 그룹에 작업을 적용할 -ManagementGroupName 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-618">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="1b7fe-619">지정된 구독에 작업을 적용할 -SubscriptionId 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-619">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="1b7fe-620">Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlet 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-620">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="1b7fe-621">지정된 관리 그룹에 작업을 적용할 -ManagementGroupName 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-621">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="1b7fe-622">지정된 구독에 작업을 적용할 -SubscriptionId 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-622">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="1b7fe-623">'New-AzureRmResourceGroupDeployment'에서 'TemplateParameterObject'를 사용하는 경우 매개 변수에 KeyVault 비밀 참조 지원 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-623">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="1b7fe-624">'New-AzureRmADAppCredential'에 대해 '-EndDate' 매개 변수가 무시되는 문제를 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-624">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="1b7fe-625">'Add-AzureRmADGroupMember'가 요청에 잘못된 URL을 사용하는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-625">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="1b7fe-626">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="1b7fe-626">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="1b7fe-627">선택적 매개 변수 -KeyValue를 New-AzureRmServiceBusKey cmdlet에 추가 하여 사용자가 KeyValue를 제공할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-627">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="1b7fe-628">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="1b7fe-628">AzureRM.Sql</span></span>
* <span data-ttu-id="1b7fe-629">New-AzureRmSqlDatabaseRestorePoint 도움말에서 SQLDW에 대한 사용자 정의 복원 지점 명시</span><span class="sxs-lookup"><span data-stu-id="1b7fe-629">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="1b7fe-630">몇 가지 cmdlet에서-ComputeGeneration 매개 변수의 설명서 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-630">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="1b7fe-631">6.3.0 - 2018년 6월</span><span class="sxs-lookup"><span data-stu-id="1b7fe-631">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="1b7fe-632">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="1b7fe-632">AzureRM.Profile</span></span>
* <span data-ttu-id="1b7fe-633">Enable-AzureRmContextAutoSave에 대한 오류 메시지 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-633">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="1b7fe-634">이전 컨텍스트 없이 'Connect-AzureRmAccount' 실행 시 각 구독에 대한 컨텍스트 생성</span><span class="sxs-lookup"><span data-stu-id="1b7fe-634">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="1b7fe-635">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="1b7fe-635">Azure.Storage</span></span>
* <span data-ttu-id="1b7fe-636">도움말 파일 내 -Permissions 매개 변수에 대한 추가 정보가 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-636">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="1b7fe-637">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="1b7fe-637">AzureRM.Compute</span></span>
* <span data-ttu-id="1b7fe-638">'Get-AzureRmVmDiskEncryptionStatus'가 데이터 디스크가 없는 VM에 대해 관찰된 문제를 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-638">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="1b7fe-639">Compute 클라이언트 라이브러리 버전을 업데이트하여 다음 cmdlet 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-639">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="1b7fe-640">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="1b7fe-640">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="1b7fe-641">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="1b7fe-641">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="1b7fe-642">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="1b7fe-642">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="1b7fe-643">다음 cmdlet이 '작업 ID' 및 '작업 상태'를 올바르게 표시하도록 수정:</span><span class="sxs-lookup"><span data-stu-id="1b7fe-643">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="1b7fe-644">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="1b7fe-644">Start-AzureRmVM</span></span>
    - <span data-ttu-id="1b7fe-645">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="1b7fe-645">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="1b7fe-646">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="1b7fe-646">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="1b7fe-647">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="1b7fe-647">Set-AzureRmVM</span></span>
    - <span data-ttu-id="1b7fe-648">Remove-AzuerRmVM</span><span class="sxs-lookup"><span data-stu-id="1b7fe-648">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="1b7fe-649">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="1b7fe-649">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="1b7fe-650">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="1b7fe-650">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="1b7fe-651">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="1b7fe-651">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="1b7fe-652">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="1b7fe-652">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="1b7fe-653">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="1b7fe-653">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="1b7fe-654">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="1b7fe-654">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="1b7fe-655">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="1b7fe-655">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="1b7fe-656">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="1b7fe-656">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="1b7fe-657">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="1b7fe-657">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="1b7fe-658">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="1b7fe-658">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="1b7fe-659">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="1b7fe-659">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="1b7fe-660">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="1b7fe-660">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="1b7fe-661">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="1b7fe-661">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="1b7fe-662">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="1b7fe-662">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="1b7fe-663">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="1b7fe-663">AzureRM.EventGrid</span></span>
* <span data-ttu-id="1b7fe-664">Update-AzureRmEventGridSubscription cmdlet의 SubjectBeginsWith/SubjectEndsWith에 대한 ValidateNotNullOrEmpty 유효성 검사 조건을 제거하여 필요에 따라 이러한 매개 변수를 빈 문자열로 변경할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-664">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="1b7fe-665">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="1b7fe-665">AzureRM.KeyVault</span></span>
* <span data-ttu-id="1b7fe-666">Get-AzureRmKeyVault -Tag 실행 시 태그가 리턴되지 않는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-666">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="1b7fe-667">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="1b7fe-667">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="1b7fe-668">Policy Insights cmdlet의 공개 릴리스</span><span class="sxs-lookup"><span data-stu-id="1b7fe-668">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="1b7fe-669">API 버전 2018-04-04 사용</span><span class="sxs-lookup"><span data-stu-id="1b7fe-669">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="1b7fe-670">PolicyDefinitionReferenceId를 Get-AzureRmPolicyStateSummary의 결과 집합에 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-670">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="1b7fe-671">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="1b7fe-671">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="1b7fe-672">-Vault 매개 변수를 RecoveryServices.Backup cmdlet에 추가.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-672">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="1b7fe-673">전달되는 경우 이는 Set-AzureRmRecoveryServicesContext cmdlet을 재정의함.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-673">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="1b7fe-674">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="1b7fe-674">AzureRM.Sql</span></span>
* <span data-ttu-id="1b7fe-675">Get-AzureRmSqlDatabaseExpanded에 대한 도움말 파일의 예가 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-675">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="1b7fe-676">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="1b7fe-676">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="1b7fe-677">Add-AzureRmTrafficManagerEndpointConfig에대한 도움말 파일이 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-677">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="1b7fe-678">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="1b7fe-678">AzureRM.Websites</span></span>
* <span data-ttu-id="1b7fe-679">-AssignIdentity를 사용할 때 AppSetting을 덮어쓰지 않도록 'Set-AzureRmWebApp'이 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-679">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="1b7fe-680">'New-AzureRmWebAppSlot'이 AppServicePlan을 옵션 매개변수로 사용하도록 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-680">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="1b7fe-681">6.2.1 - 2018년 6월</span><span class="sxs-lookup"><span data-stu-id="1b7fe-681">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="1b7fe-682">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="1b7fe-682">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="1b7fe-683">PSWorkspace 모델이 Network 형식을 매개 변수로 사용하도록 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-683">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="1b7fe-684">6.2.0 - 2018년 6월</span><span class="sxs-lookup"><span data-stu-id="1b7fe-684">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="1b7fe-685">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="1b7fe-685">AzureRM.Profile</span></span>
* <span data-ttu-id="1b7fe-686">Newtonsoft.Json의 버전 10.0.3이 모듈 가져오기에 로드되지 않는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-686">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="1b7fe-687">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="1b7fe-687">AzureRM.Compute</span></span>
* <span data-ttu-id="1b7fe-688">VMSS VM 업데이트 기능</span><span class="sxs-lookup"><span data-stu-id="1b7fe-688">VMSS VM Update feature</span></span>
    - <span data-ttu-id="1b7fe-689">'Update-AzureRmVmssVM' 및 'New-AzureRmVMDataDisk' cmdlets 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-689">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="1b7fe-690">데이터 디스크를 Vmss VM에 추가할 수 있도록 지원하기 위해 VirtualMachineScaleSetVM 매개변수를 'Add-AzureRmVMDataDisk' cmdlet에 추가하였습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-690">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="1b7fe-691">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="1b7fe-691">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="1b7fe-692">ADF .Net SDK 버전이 다음 변경 내용이 포함된 0.8.0-preview로 업데이트되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-692">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="1b7fe-693">팩터리 리포지토리 작업 구성 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-693">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="1b7fe-694">QuickBooks LinkedService가 ConsumerKey 및 consumerSecret 속성을 노출하도록 업데이트됨 </span><span class="sxs-lookup"><span data-stu-id="1b7fe-694">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="1b7fe-695">여러 모델 유형을 SecretBase에서 개체로 업데이트함</span><span class="sxs-lookup"><span data-stu-id="1b7fe-695">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="1b7fe-696">Blob 이벤트 트리거 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-696">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="1b7fe-697">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="1b7fe-697">AzureRM.KeyVault</span></span>
* <span data-ttu-id="1b7fe-698">예제 출력으로 설명서 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-698">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="1b7fe-699">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="1b7fe-699">AzureRM.Network</span></span>
* <span data-ttu-id="1b7fe-700">Network Watcher cmdlet에서 트래픽 분석 매개 변수를 사용가능하도록 설정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-700">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="1b7fe-701">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="1b7fe-701">AzureRM.Resources</span></span>
* <span data-ttu-id="1b7fe-702">'Get AzureRmResource'에서 반환된 'PSResource' 개체의 'Properties' 속성의 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-702">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="1b7fe-703">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="1b7fe-703">AzureRM.Scheduler</span></span>
* <span data-ttu-id="1b7fe-704">ServiceBusQueueJob 업데이트가 새 인증 값을 설정하지 않는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1b7fe-704">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="1b7fe-705">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="1b7fe-705">AzureRM.Sql</span></span>
* <span data-ttu-id="1b7fe-706">옵션 LicenseType 매개 변수를 사용하여 다음 cmdlet을 업데이트</span><span class="sxs-lookup"><span data-stu-id="1b7fe-706">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="1b7fe-707">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="1b7fe-707">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="1b7fe-708">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="1b7fe-708">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="1b7fe-709">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="1b7fe-709">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="1b7fe-710">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="1b7fe-710">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="1b7fe-711">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="1b7fe-711">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="1b7fe-712">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="1b7fe-712">AzureRM.Websites</span></span>
* <span data-ttu-id="1b7fe-713">'New-AzureRMWebApp'이 전략 라이브러리의 공통 알고리즘을 사용하도록 업데이트 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-713">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="1b7fe-714">6.1.0 - 2018년 5월</span><span class="sxs-lookup"><span data-stu-id="1b7fe-714">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="1b7fe-715">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="1b7fe-715">AzureRM.Profile</span></span>
* <span data-ttu-id="1b7fe-716">'Clear-AzureRmContext'를 실행하면 이전 기본 컨텍스트의 이름으로 빈 컨텍스트가 유지되어 사용자가 이전 이름으로 새 컨텍스트를 만들지 못하게 되는 문제를 수정했습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-716">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="1b7fe-717">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="1b7fe-717">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="1b7fe-718">AS에서 게이트웨이가 작업을 연결하거나 연결 해제할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-718">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="1b7fe-719">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="1b7fe-719">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="1b7fe-720">ApiVersions, ApiReleases 및 ApiRevisions에 대한 지원이 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-720">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="1b7fe-721">ServiceFabric 백 엔드에 대한 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-721">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="1b7fe-722">Application Insights 로거에 대한 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-722">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="1b7fe-723">'기본' SKU를 API Management 서비스의 유효한 SKU로 인식하는 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-723">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="1b7fe-724">개인 CA가 발급한 인증서를 루트 또는 CA로 설치하는 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-724">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="1b7fe-725">KeyVault 및 다중 프록시 호스트 이름을 통한 사용자 정의 SSL 인증서를 수락하는 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-725">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="1b7fe-726">MSI ID에 대한 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="1b7fe-726">Added support for MSI identity</span></span>
* <span data-ttu-id="1b7fe-727">URL을 통한 정책을 수락하는 지원 추가됨 참고: 다음 cmdlet은 이후 릴리스에서 더 이상 사용되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-727">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="1b7fe-728">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="1b7fe-728">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="1b7fe-729">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="1b7fe-729">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="1b7fe-730">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="1b7fe-730">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="1b7fe-731">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="1b7fe-731">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="1b7fe-732">AzureRM.Backup</span><span class="sxs-lookup"><span data-stu-id="1b7fe-732">AzureRM.Batch</span></span>
* <span data-ttu-id="1b7fe-733">새 cmdlet Get AzureBatchPoolNodeCounts 릴리스</span><span class="sxs-lookup"><span data-stu-id="1b7fe-733">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="1b7fe-734">새 cmdlet Start-AzureBatchComputeNodeServiceLogUpload 릴리스</span><span class="sxs-lookup"><span data-stu-id="1b7fe-734">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="1b7fe-735">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="1b7fe-735">AzureRM.Consumption</span></span>
* <span data-ttu-id="1b7fe-736">Expand, ResourceGroup, InstanceName, InstanceId, Tags, Top on Cmdlet Get-AzureRmConsumptionUsageDetail 등 새 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="1b7fe-736">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="1b7fe-737">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="1b7fe-737">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="1b7fe-738">Export-AzureRmDataLakeStoreChildItemProperties에 대한 예제 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-738">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="1b7fe-739">Set-AzureRmDataLakeStoreItemAclEntry에서 재귀 사례에 대한 null 매개 변수 예외 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-739">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="1b7fe-740">Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry에 대한 도움말 파일 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-740">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="1b7fe-741">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="1b7fe-741">AzureRM.Network</span></span>
* <span data-ttu-id="1b7fe-742">18.0.0-preview에서 19.0.0-preview로 네트워크 SDK 버전 업그레이드</span><span class="sxs-lookup"><span data-stu-id="1b7fe-742">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="1b7fe-743">프로토콜 구성을 만들기 위해 추가된 cmdlet</span><span class="sxs-lookup"><span data-stu-id="1b7fe-743">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="1b7fe-744">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="1b7fe-744">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="1b7fe-745">기존 Express 경로 회로에 새 회로 연결을 추가하기 위해 추가된 cmdlet</span><span class="sxs-lookup"><span data-stu-id="1b7fe-745">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="1b7fe-746">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="1b7fe-746">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="1b7fe-747">기존 Express 경로 회로에서 회로 연결을 제거하기 위해 추가된 cmdlet</span><span class="sxs-lookup"><span data-stu-id="1b7fe-747">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="1b7fe-748">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="1b7fe-748">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="1b7fe-749">회로 연결을 검색하기 위해 추가된 cmdlet</span><span class="sxs-lookup"><span data-stu-id="1b7fe-749">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="1b7fe-750">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="1b7fe-750">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="1b7fe-751">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="1b7fe-751">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="1b7fe-752">생성된 인증서로 고정 서버 인증 사용(문제 # 5998)</span><span class="sxs-lookup"><span data-stu-id="1b7fe-752">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="1b7fe-753">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="1b7fe-753">AzureRM.Sql</span></span>
* <span data-ttu-id="1b7fe-754">AuditActions 또는 AuditActionGroups를 제거할 수 있도록 업데이트된 감사 cmdlet</span><span class="sxs-lookup"><span data-stu-id="1b7fe-754">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="1b7fe-755">'Azure 복구 서비스 자격 증명 모음을 사용하여 장기 보존 정책을 구성하면 정책이 더 이상 지원되지 않습니다. 새로운 유연 보유 정책으로 요청을 제출하십시오.'라는 메시지와 함께 명령이 실패하는 새로운 유연 보유 정책을 설정할 때</span><span class="sxs-lookup"><span data-stu-id="1b7fe-755">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="1b7fe-756">Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy의 문제 수정</span><span class="sxs-lookup"><span data-stu-id="1b7fe-756">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="1b7fe-757">Azure SQL Database/ElasticPool Creation/Update 관련 cmdlet을 모두 업데이트하여 규모 및 계층 관련 속성에 대한 SKU 속성을 지원하는 새 데이터베이스 API를 사용합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-757">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="1b7fe-758">업데이트된 cmdlet는 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-758">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="1b7fe-759">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="1b7fe-759">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="1b7fe-760">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="1b7fe-760">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="1b7fe-761">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="1b7fe-761">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="1b7fe-762">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="1b7fe-762">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="1b7fe-763">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="1b7fe-763">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="1b7fe-764">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="1b7fe-764">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="1b7fe-765">-Name 매개 변수를 사용할 때 -ResourceGroupName 매개 변수가 필요하도록 'Get-AzureRmTrafficManagerProfile'에 대한 매개 변수를 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="1b7fe-765">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
