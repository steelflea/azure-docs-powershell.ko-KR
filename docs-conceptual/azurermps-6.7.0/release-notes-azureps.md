...
#### <a name="azurestorage"></a><span data-ttu-id="b7f9c-111">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="b7f9c-111">Azure.Storage</span></span>
...
#### <a name="azurermbilling"></a><span data-ttu-id="b7f9c-128">AzureRM.Billing</span><span class="sxs-lookup"><span data-stu-id="b7f9c-128">AzureRM.Billing</span></span>
...
#### <a name="azurermdatafactories"></a><span data-ttu-id="b7f9c-146">AzureRM.DataFactories</span><span class="sxs-lookup"><span data-stu-id="b7f9c-146">AzureRM.DataFactories</span></span>
...
#### <a name="azurermeventhub"></a><span data-ttu-id="b7f9c-163">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="b7f9c-163">AzureRM.EventHub</span></span>
...
#### <a name="azurermmedia"></a><span data-ttu-id="b7f9c-181">AzureRM.Media</span><span class="sxs-lookup"><span data-stu-id="b7f9c-181">AzureRM.Media</span></span>
...
#### <a name="azurermpowerbiembedded"></a><span data-ttu-id="b7f9c-198">AzureRM.PowerBIEmbedded</span><span class="sxs-lookup"><span data-stu-id="b7f9c-198">AzureRM.PowerBIEmbedded</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="b7f9c-216">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b7f9c-216">AzureRM.Resources</span></span>
...
#### <a name="azurermstorage"></a><span data-ttu-id="b7f9c-237">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="b7f9c-237">AzureRM.Storage</span></span>
...
#### <a name="azurestorage"></a><span data-ttu-id="b7f9c-255">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="b7f9c-255">Azure.Storage</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="b7f9c-276">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="b7f9c-276">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="b7f9c-292">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b7f9c-292">AzureRM.Resources</span></span>
...
#### <a name="azurermstorage"></a><span data-ttu-id="b7f9c-307">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="b7f9c-307">AzureRM.Storage</span></span>
...
#### <a name="azurermcompute"></a><span data-ttu-id="b7f9c-326">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b7f9c-326">AzureRM.Compute</span></span>
...
#### <a name="azurermrelay"></a><span data-ttu-id="b7f9c-345">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="b7f9c-345">AzureRM.Relay</span></span>
...
#### <a name="azurermsql"></a><span data-ttu-id="b7f9c-364">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b7f9c-364">AzureRM.Sql</span></span>
...
* <span data-ttu-id="b7f9c-383">Vmss에 대한 OS 업그레이드 기록 기능</span><span class="sxs-lookup"><span data-stu-id="b7f9c-383">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="b7f9c-384">Get-AzureRmVmss에 OSUpgradeHistory 스위치 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="b7f9c-384">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>
...
#### <a name="azurermkeyvault"></a><span data-ttu-id="b7f9c-400">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b7f9c-400">AzureRM.KeyVault</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="b7f9c-417">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b7f9c-417">AzureRM.Resources</span></span>
...
#### <a name="azurermsql"></a><span data-ttu-id="b7f9c-433">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b7f9c-433">AzureRM.Sql</span></span>
...
* <span data-ttu-id="b7f9c-448">다음 cmdlet이 '작업 ID' 및 '작업 상태'를 올바르게 표시하도록 수정:</span><span class="sxs-lookup"><span data-stu-id="b7f9c-448">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="b7f9c-449">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b7f9c-449">Start-AzureRmVM</span></span>
    - <span data-ttu-id="b7f9c-450">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b7f9c-450">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="b7f9c-451">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b7f9c-451">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="b7f9c-452">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b7f9c-452">Set-AzureRmVM</span></span>
    - <span data-ttu-id="b7f9c-453">Remove-AzuerRmVM</span><span class="sxs-lookup"><span data-stu-id="b7f9c-453">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="b7f9c-454">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b7f9c-454">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="b7f9c-455">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="b7f9c-455">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="b7f9c-456">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="b7f9c-456">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="b7f9c-457">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b7f9c-457">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="b7f9c-458">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b7f9c-458">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="b7f9c-459">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b7f9c-459">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="b7f9c-460">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b7f9c-460">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="b7f9c-461">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="b7f9c-461">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="b7f9c-462">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="b7f9c-462">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="b7f9c-463">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="b7f9c-463">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="b7f9c-464">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="b7f9c-464">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="b7f9c-465">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="b7f9c-465">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="b7f9c-466">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="b7f9c-466">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="b7f9c-467">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="b7f9c-467">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="b7f9c-468">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="b7f9c-468">AzureRM.EventGrid</span></span>
* <span data-ttu-id="b7f9c-469">Update-AzureRmEventGridSubscription cmdlet의 SubjectBeginsWith/SubjectEndsWith에 대한 ValidateNotNullOrEmpty 유효성 검사 조건을 제거하여 필요에 따라 이러한 매개 변수를 빈 문자열로 변경할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-469">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b7f9c-470">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b7f9c-470">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b7f9c-471">Get-AzureRmKeyVault -Tag 실행 시 태그가 리턴되지 않는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="b7f9c-471">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="b7f9c-472">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="b7f9c-472">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="b7f9c-473">Policy Insights cmdlet의 공개 릴리스</span><span class="sxs-lookup"><span data-stu-id="b7f9c-473">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="b7f9c-474">API 버전 2018-04-04 사용</span><span class="sxs-lookup"><span data-stu-id="b7f9c-474">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="b7f9c-475">PolicyDefinitionReferenceId를 Get-AzureRmPolicyStateSummary의 결과 집합에 추가</span><span class="sxs-lookup"><span data-stu-id="b7f9c-475">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="b7f9c-476">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="b7f9c-476">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="b7f9c-477">-Vault 매개 변수를 RecoveryServices.Backup cmdlet에 추가.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-477">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="b7f9c-478">전달되는 경우 이는 Set-AzureRmRecoveryServicesContext cmdlet을 재정의함.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-478">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b7f9c-479">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b7f9c-479">AzureRM.Sql</span></span>
* <span data-ttu-id="b7f9c-480">Get-AzureRmSqlDatabaseExpanded에 대한 도움말 파일의 예가 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-480">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="b7f9c-481">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="b7f9c-481">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="b7f9c-482">Add-AzureRmTrafficManagerEndpointConfig에대한 도움말 파일이 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-482">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b7f9c-483">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b7f9c-483">AzureRM.Websites</span></span>
* <span data-ttu-id="b7f9c-484">-AssignIdentity를 사용할 때 AppSetting을 덮어쓰지 않도록 'Set-AzureRmWebApp'이 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-484">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="b7f9c-485">'New-AzureRmWebAppSlot'이 AppServicePlan을 옵션 매개변수로 사용하도록 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-485">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="b7f9c-486">6.2.1 - 2018년 6월</span><span class="sxs-lookup"><span data-stu-id="b7f9c-486">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="b7f9c-487">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="b7f9c-487">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="b7f9c-488">PSWorkspace 모델이 Network 형식을 매개 변수로 사용하도록 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-488">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="b7f9c-489">6.2.0 - 2018년 6월</span><span class="sxs-lookup"><span data-stu-id="b7f9c-489">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b7f9c-490">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b7f9c-490">AzureRM.Profile</span></span>
* <span data-ttu-id="b7f9c-491">Newtonsoft.Json의 버전 10.0.3이 모듈 가져오기에 로드되지 않는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="b7f9c-491">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b7f9c-492">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b7f9c-492">AzureRM.Compute</span></span>
* <span data-ttu-id="b7f9c-493">VMSS VM 업데이트 기능</span><span class="sxs-lookup"><span data-stu-id="b7f9c-493">VMSS VM Update feature</span></span>
    - <span data-ttu-id="b7f9c-494">'Update-AzureRmVmssVM' 및 'New-AzureRmVMDataDisk' cmdlets 추가</span><span class="sxs-lookup"><span data-stu-id="b7f9c-494">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="b7f9c-495">데이터 디스크를 Vmss VM에 추가할 수 있도록 지원하기 위해 VirtualMachineScaleSetVM 매개변수를 'Add-AzureRmVMDataDisk' cmdlet에 추가하였습니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-495">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="b7f9c-496">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="b7f9c-496">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="b7f9c-497">ADF .Net SDK 버전이 다음 변경 내용이 포함된 0.8.0-preview로 업데이트되었습니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-497">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="b7f9c-498">팩터리 리포지토리 작업 구성 추가</span><span class="sxs-lookup"><span data-stu-id="b7f9c-498">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="b7f9c-499">QuickBooks LinkedService가 ConsumerKey 및 consumerSecret 속성을 노출하도록 업데이트됨 </span><span class="sxs-lookup"><span data-stu-id="b7f9c-499">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="b7f9c-500">여러 모델 유형을 SecretBase에서 개체로 업데이트함</span><span class="sxs-lookup"><span data-stu-id="b7f9c-500">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="b7f9c-501">Blob 이벤트 트리거 추가</span><span class="sxs-lookup"><span data-stu-id="b7f9c-501">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="b7f9c-502">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b7f9c-502">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b7f9c-503">예제 출력으로 설명서 업데이트</span><span class="sxs-lookup"><span data-stu-id="b7f9c-503">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="b7f9c-504">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b7f9c-504">AzureRM.Network</span></span>
* <span data-ttu-id="b7f9c-505">Network Watcher cmdlet에서 트래픽 분석 매개 변수를 사용가능하도록 설정</span><span class="sxs-lookup"><span data-stu-id="b7f9c-505">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b7f9c-506">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b7f9c-506">AzureRM.Resources</span></span>
* <span data-ttu-id="b7f9c-507">'Get AzureRmResource'에서 반환된 'PSResource' 개체의 'Properties' 속성의 문제 해결</span><span class="sxs-lookup"><span data-stu-id="b7f9c-507">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="b7f9c-508">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="b7f9c-508">AzureRM.Scheduler</span></span>
* <span data-ttu-id="b7f9c-509">ServiceBusQueueJob 업데이트가 새 인증 값을 설정하지 않는 문제 해결</span><span class="sxs-lookup"><span data-stu-id="b7f9c-509">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="b7f9c-510">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b7f9c-510">AzureRM.Sql</span></span>
* <span data-ttu-id="b7f9c-511">옵션 LicenseType 매개 변수를 사용하여 다음 cmdlet을 업데이트</span><span class="sxs-lookup"><span data-stu-id="b7f9c-511">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="b7f9c-512">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b7f9c-512">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="b7f9c-513">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="b7f9c-513">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="b7f9c-514">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="b7f9c-514">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="b7f9c-515">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="b7f9c-515">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="b7f9c-516">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b7f9c-516">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b7f9c-517">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b7f9c-517">AzureRM.Websites</span></span>
* <span data-ttu-id="b7f9c-518">'New-AzureRMWebApp'이 전략 라이브러리의 공통 알고리즘을 사용하도록 업데이트 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-518">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="b7f9c-519">6.1.0 - 2018년 5월</span><span class="sxs-lookup"><span data-stu-id="b7f9c-519">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b7f9c-520">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b7f9c-520">AzureRM.Profile</span></span>
* <span data-ttu-id="b7f9c-521">'Clear-AzureRmContext'를 실행하면 이전 기본 컨텍스트의 이름으로 빈 컨텍스트가 유지되어 사용자가 이전 이름으로 새 컨텍스트를 만들지 못하게 되는 문제를 수정했습니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-521">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="b7f9c-522">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="b7f9c-522">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="b7f9c-523">AS에서 게이트웨이가 작업을 연결하거나 연결 해제할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-523">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="b7f9c-524">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b7f9c-524">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="b7f9c-525">ApiVersions, ApiReleases 및 ApiRevisions에 대한 지원이 추가됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-525">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="b7f9c-526">ServiceFabric 백 엔드에 대한 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-526">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="b7f9c-527">Application Insights 로거에 대한 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-527">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="b7f9c-528">'기본' SKU를 API Management 서비스의 유효한 SKU로 인식하는 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-528">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="b7f9c-529">개인 CA가 발급한 인증서를 루트 또는 CA로 설치하는 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-529">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="b7f9c-530">KeyVault 및 다중 프록시 호스트 이름을 통한 사용자 정의 SSL 인증서를 수락하는 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-530">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="b7f9c-531">MSI ID에 대한 지원 추가됨</span><span class="sxs-lookup"><span data-stu-id="b7f9c-531">Added support for MSI identity</span></span>
* <span data-ttu-id="b7f9c-532">URL을 통한 정책을 수락하는 지원 추가됨 참고: 다음 cmdlet은 이후 릴리스에서 더 이상 사용되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-532">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="b7f9c-533">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="b7f9c-533">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="b7f9c-534">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="b7f9c-534">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="b7f9c-535">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="b7f9c-535">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="b7f9c-536">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="b7f9c-536">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="b7f9c-537">AzureRM.Backup</span><span class="sxs-lookup"><span data-stu-id="b7f9c-537">AzureRM.Batch</span></span>
* <span data-ttu-id="b7f9c-538">새 cmdlet Get AzureBatchPoolNodeCounts 릴리스</span><span class="sxs-lookup"><span data-stu-id="b7f9c-538">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="b7f9c-539">새 cmdlet Start-AzureBatchComputeNodeServiceLogUpload 릴리스</span><span class="sxs-lookup"><span data-stu-id="b7f9c-539">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="b7f9c-540">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="b7f9c-540">AzureRM.Consumption</span></span>
* <span data-ttu-id="b7f9c-541">Expand, ResourceGroup, InstanceName, InstanceId, Tags, Top on Cmdlet Get-AzureRmConsumptionUsageDetail 등 새 매개 변수 추가</span><span class="sxs-lookup"><span data-stu-id="b7f9c-541">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="b7f9c-542">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b7f9c-542">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="b7f9c-543">Export-AzureRmDataLakeStoreChildItemProperties에 대한 예제 수정</span><span class="sxs-lookup"><span data-stu-id="b7f9c-543">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="b7f9c-544">Set-AzureRmDataLakeStoreItemAclEntry에서 재귀 사례에 대한 null 매개 변수 예외 수정</span><span class="sxs-lookup"><span data-stu-id="b7f9c-544">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="b7f9c-545">Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry에 대한 도움말 파일 수정</span><span class="sxs-lookup"><span data-stu-id="b7f9c-545">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="b7f9c-546">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b7f9c-546">AzureRM.Network</span></span>
* <span data-ttu-id="b7f9c-547">18.0.0-preview에서 19.0.0-preview로 네트워크 SDK 버전 업그레이드</span><span class="sxs-lookup"><span data-stu-id="b7f9c-547">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="b7f9c-548">프로토콜 구성을 만들기 위해 추가된 cmdlet</span><span class="sxs-lookup"><span data-stu-id="b7f9c-548">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="b7f9c-549">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="b7f9c-549">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="b7f9c-550">기존 Express 경로 회로에 새 회로 연결을 추가하기 위해 추가된 cmdlet</span><span class="sxs-lookup"><span data-stu-id="b7f9c-550">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="b7f9c-551">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b7f9c-551">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="b7f9c-552">기존 Express 경로 회로에서 회로 연결을 제거하기 위해 추가된 cmdlet</span><span class="sxs-lookup"><span data-stu-id="b7f9c-552">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="b7f9c-553">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b7f9c-553">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="b7f9c-554">회로 연결을 검색하기 위해 추가된 cmdlet</span><span class="sxs-lookup"><span data-stu-id="b7f9c-554">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="b7f9c-555">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b7f9c-555">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="b7f9c-556">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="b7f9c-556">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="b7f9c-557">생성된 인증서로 고정 서버 인증 사용(문제 # 5998)</span><span class="sxs-lookup"><span data-stu-id="b7f9c-557">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b7f9c-558">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b7f9c-558">AzureRM.Sql</span></span>
* <span data-ttu-id="b7f9c-559">AuditActions 또는 AuditActionGroups를 제거할 수 있도록 업데이트된 감사 cmdlet</span><span class="sxs-lookup"><span data-stu-id="b7f9c-559">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="b7f9c-560">'Azure 복구 서비스 자격 증명 모음을 사용하여 장기 보존 정책을 구성하면 정책이 더 이상 지원되지 않습니다. 새로운 유연 보유 정책으로 요청을 제출하십시오.'라는 메시지와 함께 명령이 실패하는 새로운 유연 보유 정책을 설정할 때</span><span class="sxs-lookup"><span data-stu-id="b7f9c-560">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="b7f9c-561">Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy의 문제 수정</span><span class="sxs-lookup"><span data-stu-id="b7f9c-561">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="b7f9c-562">Azure SQL Database/ElasticPool Creation/Update 관련 cmdlet을 모두 업데이트하여 규모 및 계층 관련 속성에 대한 SKU 속성을 지원하는 새 데이터베이스 API를 사용합니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-562">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="b7f9c-563">업데이트된 cmdlet는 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-563">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="b7f9c-564">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b7f9c-564">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="b7f9c-565">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="b7f9c-565">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="b7f9c-566">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="b7f9c-566">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="b7f9c-567">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="b7f9c-567">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="b7f9c-568">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b7f9c-568">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="b7f9c-569">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="b7f9c-569">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="b7f9c-570">-Name 매개 변수를 사용할 때 -ResourceGroupName 매개 변수가 필요하도록 'Get-AzureRmTrafficManagerProfile'에 대한 매개 변수를 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="b7f9c-570">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
