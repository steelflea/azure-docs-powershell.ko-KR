...
### <a id="update-azps"></a><span data-ttu-id="6b1a4-154">새 Azure PowerShell 버전으로 업데이트</span><span class="sxs-lookup"><span data-stu-id="6b1a4-154">Updating to a new version of Azure PowerShell</span></span>
