...
이제 제공한 *appId* 및 자동으로 생성된 *암호*를 사용하여 앱에 새로운 서비스 주체로 로그인할 수 있습니다. 또한 서비스 주체에 대한 테넌트 ID가 필요합니다. 개인 자격 증명을 사용하여 Azure에 로그인하는 경우 테넌트 ID가 표시됩니다. 서비스 주체로 로그인하려면 다음 명령을 사용합니다.
