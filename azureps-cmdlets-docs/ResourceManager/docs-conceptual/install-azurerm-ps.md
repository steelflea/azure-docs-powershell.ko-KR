...
### <span data-ttu-id="092fb-154"><a id="update-azps"></a>새 Azure PowerShell 버전으로 업데이트</span><span class="sxs-lookup"><span data-stu-id="092fb-154"><a id="update-azps"></a>Updating to a new version of Azure PowerShell</span></span>
