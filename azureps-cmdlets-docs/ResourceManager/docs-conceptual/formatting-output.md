...
| <span data-ttu-id="36249-106">서식 지정</span><span class="sxs-lookup"><span data-stu-id="36249-106">Formatting</span></span>      | <span data-ttu-id="36249-107">변환</span><span class="sxs-lookup"><span data-stu-id="36249-107">Conversion</span></span>       |
|-----------------|------------------|
...
<span data-ttu-id="36249-111">반환되는 열을 제한하려는 경우 `Format-Table` cmdlet을 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="36249-111">If you would like to limit the columns returned you can use the `Format-Table` cmdlet.</span></span> <span data-ttu-id="36249-112">다음 예제에서는 가상 컴퓨터의 동일한 목록을 가져오지만 VM의 이름, 리소스 그룹 및 VM의 위치에 대한 출력을 제한합니다.</span><span class="sxs-lookup"><span data-stu-id="36249-112">In the following example we get the same list of virtual machines but restrict the output to just the name of the VM, the resource group, and the location of the VM.</span></span>  <span data-ttu-id="36249-113">`-Autosize` 매개 변수는 데이터의 크기에 따라 열 크기를 지정합니다.</span><span class="sxs-lookup"><span data-stu-id="36249-113">The `-Autosize` parameter sizes the columns according to the size of the data.</span></span>
...
<span data-ttu-id="36249-114">선호하는 목록 형식에서 정보를 볼 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="36249-114">If you would prefer you can view information in a list format.</span></span> <span data-ttu-id="36249-115">다음 예제에서는 `Format-List` cmdlet을 사용하여 이를 보여 줍니다.</span><span class="sxs-lookup"><span data-stu-id="36249-115">The following example shows this using the`Format-List` cmdlet.</span></span>
...
<span data-ttu-id="36249-119">출력을 JSON 형식으로 변환할 수도 있습니다.</span><span class="sxs-lookup"><span data-stu-id="36249-119">You can also convert the output into JSON format.</span></span>  <span data-ttu-id="36249-120">다음 예제에서는 VM의 동일한 목록을 만들지만 출력 형식을 JSON으로 변경합니다.</span><span class="sxs-lookup"><span data-stu-id="36249-120">The following example creates the same list of VMs but changes the output format to JSON.</span></span>
